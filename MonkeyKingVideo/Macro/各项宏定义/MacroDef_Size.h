...
#define MAINSCREEN_WIDTH    MianScreen.width//获取屏幕宽高
#define MAINSCREEN_HEIGHT   MianScreen.height

#define SCREEN_MAX_LENGTH   (MAX(MAINSCREEN_WIDTH, MAINSCREEN_HEIGHT))
#define SCREEN_MIN_LENGTH   (MIN(MAINSCREEN_WIDTH, MAINSCREEN_HEIGHT))

#define kTabBarHeight             (isiPhoneX_series() ? 83 : 49)
#define KNavigationItemSpace     -15
#define KBottomHeight   (isiPhoneX_series() ? 34 : 0)
...
static inline CGFloat TabBarHeight(){
    //即时获取
    CGFloat tabBarHeight = AppDelegate.sharedInstance.customSYSUITabBarController.lzb_tabBar.frame.size.height;
...
//    return TabBarHeight() - 49 - AppDelegate.sharedInstance.customSYSUITabBarController.lzb_tabBar.offsetHeight;
//}
