...
//自定义颜色
#define MKBakcColor HEXCOLOR(0x242a37)
#define MKTextColor HEXCOLOR(0xc4c1c1)
#define MKSelectColor HEXCOLOR(0xf54b64)
#define MKNoSelectColor HEXCOLOR(0xffffff)
#define MKBorderColor HEXCOLOR(0x4b5774)
#define MKSignColor HEXCOLOR(0x666e87)
#define MKFanNumColor HEXCOLOR(0x9ca5c3)
#define MKSelectTextColor HEXCOLOR(0xf54b64)
