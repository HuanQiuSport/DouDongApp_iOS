...
- (void)textFieldDidBeginEditing:(UITextField *)textField{
    if ([textField.placeholder isEqualToString:@"6-12位字母或数字的密码"] || [textField.placeholder isEqualToString:@"确认6-12位字母或数字的密码"]) {
...
-(UIButton *)securityModeBtn{
    if (!_securityModeBtn) {
        ...
        [_securityModeBtn setImage:[UIImage imageNamed:@"codeDecode@3x"]
                          forState:UIControlStateNormal];
        [_securityModeBtn setImage:[UIImage imageNamed:@"codeEncode@3x"]
