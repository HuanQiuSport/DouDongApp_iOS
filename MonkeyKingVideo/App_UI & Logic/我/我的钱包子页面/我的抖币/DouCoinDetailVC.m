...
-(instancetype)init{
    if (self = [super init]) {
        self.walletStyle = MyWalletStyle_CURRENTDOUCOIN;
    }return self;
}
...
heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return [MKDouCoinTBCell cellHeightWithModel:NULL];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    MKDouCoinTBCell *cell = [MKDouCoinTBCell cellWith:tableView];
