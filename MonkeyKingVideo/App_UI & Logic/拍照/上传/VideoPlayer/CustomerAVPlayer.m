...
- (void)playerItemDidReachEnd:(NSNotification *)notification {
     @autoreleasepool {
         self.itemPlayer = [notification object];
//            [p seekToTime:kCMTimeZero];
         [self.itemPlayer seekToTime:kCMTimeZero toleranceBefore:kCMTimePositiveInfinity toleranceAfter:kCMTimePositiveInfinity completionHandler:nil];
