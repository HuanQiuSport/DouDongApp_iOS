...
//            }
        ...
        self.SCRV.contentSize = CGSizeMake(kViewMaxX(lastLab), 0);
...
- (void)scrollTo:(int)index {
    ...
    [self.SCRV setContentOffset:CGPointMake(index * (self.lableMid + self.lableWidth), 0)
                       animated:YES];
//      lab.textColor      =  [UIColor colorWithPatternImage:[UIImage imageResize:KIMG(@"gradualColor") andResizeTo:CGSizeMake(SCALING_RATIO(90), 30)]];
}
...
//            showingLab.font = [UIFont systemFontOfSize:18];
...
//                                           self.minHeight +
//                                           (self.maxHeight - self.minHeight) * (1 - offsetRait));
//                nextLab.font = [UIFont systemFontOfSize:18];
...
//                                       kViewWidth(lastLab),
//                                       self.minHeight);
//            lastLab.font = [UIFont systemFontOfSize:18];
...
//                                        kViewWidth(next2Lab),
//                                        self.minHeight);
//            next2Lab.font = [UIFont systemFontOfSize:18];
