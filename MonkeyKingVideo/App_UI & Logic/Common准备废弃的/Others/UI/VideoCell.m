...
//            self.mkBackImageView.contentScaleFactor = 0.5;
            ...
            [self.showDataBtn mas_remakeConstraints:^(MASConstraintMaker *make) {
                make.left.equalTo(self.contentView.mas_left).offset(5*1);
...
//            [self.mkBackImageView sd_setImageWithURL:[NSURL URLWithString:self.mkVideoModel.videoImg] placeholderImage:KIMG(@"videoFont")];
            ...
            [self.mkBackImageView  mas_updateConstraints:^(MASConstraintMaker *make) {
                make.bottom.equalTo(self.mkBotomBackView).offset(-35*1);
            }];
...
-(UIButton *)showDataBtn{
    if (!_showDataBtn) {
        ...
        [_showDataBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.equalTo(self.contentView.mas_top).offset(5 * 1);
...
- (UIImageView *)mkVideoUserImageView{
    ...
    if (!_mkVideoUserImageView) {
        ...
        _mkVideoUserImageView.layer.cornerRadius = 1 * 25 /2;
        
        _mkVideoUserImageView.layer.borderColor = [UIColor colorWithPatternImage:[UIImage imageResize:KIMG(@"gradualColor") andResizeTo:CGSizeMake(40, 30)]].CGColor;
        ...
        [_mkVideoUserImageView mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(self.mkBotomBackView).offset(8 * 1);
            make.bottom.equalTo(self.titleLab).offset(-19);

            make.width.height.equalTo(@(1 *25));
...
- (UILabel *)mkStatusLabel{
    ...
    if (!_mkStatusLabel) {
        ...
        _mkStatusLabel.layer.cornerRadius = 9*1 ;
        ...
        [_mkStatusLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.height.equalTo(@(18 *1));
            
            make.right.equalTo(self.contentView.mas_right).offset(-2*1);
            
            make.top.equalTo(self.contentView.mas_top).offset(2*1);
