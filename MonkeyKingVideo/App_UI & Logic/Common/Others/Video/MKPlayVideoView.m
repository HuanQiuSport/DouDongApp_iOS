...
- (void)mkAddSubView{
    ...
    self.mkVideoView.frame = CGRectMake(0, 0, kScreenWidth, kScreenHeight);
...
- (UIView *)mkVideoView{
    ...
    if (!_mkVideoView) {
        ...
        _mkVideoView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight)];
    }
    return _mkVideoView;
}
...
- (MKPlayUserInfoView *)mkPlayUserView{
    ...
    if (!_mkPlayUserView) {
        ...
        _mkPlayUserView = [[MKPlayUserInfoView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight)];
