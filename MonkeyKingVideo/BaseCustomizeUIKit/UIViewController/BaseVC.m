...
-(MJRefreshGifHeader *)tableViewHeader{
    if (!_tableViewHeader) {
        ...
        [_tableViewHeader setImages:@[KIMG(@"gif_header_5@3x")]
                           forState:MJRefreshStateIdle];
        [_tableViewHeader setImages:@[KIMG(@"gif_header_9@3x")]
        ...
        _tableViewHeader.stateLabel.hidden = 1;
        _tableViewHeader.lastUpdatedTimeLabel.hidden = 1;
...
-(MJRefreshAutoGifFooter *)tableViewFooter{
    if (!_tableViewFooter) {
        ...
        // 设置普通状态的动画图片
        [_tableViewFooter setImages:@[KIMG(@"gif_header_5@3x")]
                           forState:MJRefreshStateIdle];
        // 设置即将刷新状态的动画图片（一松开就会刷新的状态）
        [_tableViewFooter setImages:@[KIMG(@"gif_header_9@3x")]
                           forState:MJRefreshStatePulling];
        // 设置正在刷新状态的动画图片
...
//                           forState:MJRefreshStateRefreshing];
        ...
        // 设置字体
        _tableViewFooter.stateLabel.font = [UIFont systemFontOfSize:12];
        // 设置颜色
