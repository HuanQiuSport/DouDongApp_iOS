...
-(SPAlertController *)SPAlertControllerWithType:(BaseVC_SPAlertControllerInitType)SPAlertControllerInitType
    ...
    switch (SPAlertControllerInitType) {
        case BaseVC_SPAlertControllerInitType_1:{
        ...
        case BaseVC_SPAlertControllerInitType_2:{
        ...
        case BaseVC_SPAlertControllerInitType_3:{
        ...
        case BaseVC_SPAlertControllerInitType_4:{
            // 示例18:自定义头部(xib)
        ...
        case BaseVC_SPAlertControllerInitType_5:{
            // 示例25:自定义action部分
        ...
        case BaseVC_SPAlertControllerInitType_6:{
