...
@property(nonatomic,assign)NSInteger toReplyUserId;
...
@property(nonatomic,strong)NSMutableArray <MKChildCommentModel *>*child;
@property(nonatomic,strong)NSString *commentDate;
@property(nonatomic,strong)NSString *commentId;
@property(nonatomic,strong)NSString *content;//第一级
@property(nonatomic,strong)NSString *headImg;
@property(nonatomic,strong)NSString *ID;
@property(nonatomic,strong)NSNumber *isPraise;//是否点赞 对于当前用户
@property(nonatomic,strong)NSString *nickname;
@property(nonatomic,strong)NSNumber *parentId;
@property(nonatomic,strong)NSNumber *praiseNum;//全局的 点赞数量
