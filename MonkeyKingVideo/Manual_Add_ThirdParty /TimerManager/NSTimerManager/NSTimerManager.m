...
//    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(deteleTimerNotification:) name:MKDeleteTimerNotification object:nil];
...
- (void)deteleTimerNotification:(NSNotification *)notification {
